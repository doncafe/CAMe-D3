...
def plot_wrf_domains_single_map(geo_em_files, output_file='operativo_4.2.1_dominios.png', dpi=300):
    """
    ...
    plt.title('Dominios del Modelo WRF 4.2.1')
...
if __name__ == "__main__":
    ...
    plot_wrf_domains_single_map(
        geo_em_files,
        output_file='wrf_dominios_operativo2.png',
        dpi=300
    )
